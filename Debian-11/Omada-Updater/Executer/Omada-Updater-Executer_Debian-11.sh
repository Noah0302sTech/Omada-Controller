...
cd /home/$SUDO_USER/Noah0302sTech/Omada-Controller/Debian-11/Omada-Package
	#----- Install Omada
		...
		#--- Prompt user for the Omada download URL or use the default if left blank
			while true; do
				read -t 30 -p "Füge die Download-URL für Omada_SDN_Controller_vX.X.X_Linux_x64.deb hier ein (Leer oder warte 30 Sekunden für v5.13.30.8): " omada_url
				if [ -z "$omada_url" ]; then
					omada_url="https://static.tp-link.com/upload/software/2024/202402/20240227/Omada_SDN_Controller_v5.13.30.8_linux_x64.deb"
					break
