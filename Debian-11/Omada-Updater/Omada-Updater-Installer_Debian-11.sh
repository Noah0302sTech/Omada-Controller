...
#	wget https://raw.githubusercontent.com/Noah0302sTech/Omada-Controller/master/Debian-11/Omada-Updater/Omada-Updater-Installer_Debian-11.sh && sudo bash Omada-Updater-Installer_Debian-11.sh
